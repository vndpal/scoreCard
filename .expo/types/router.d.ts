...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(tabs)` | `/_sitemap` | `/createMatch` | `/createPlayer` | `/createTeam` | `/explore` | `/matchSettings` | `/matchSummary` | `/menu` | `/playerRecords` | `/players` | `/settings` | `/teamLineup` | `/toss`;
