...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(tabs)` | `/_sitemap` | `/club` | `/createMatch` | `/createPlayer` | `/createTeam` | `/explore` | `/matchSettings` | `/matchSummary` | `/menu` | `/playerRecords` | `/players` | `/settings` | `/teamLineup` | `/toss`;
