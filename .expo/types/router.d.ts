...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(tabs)` | `/..\hooks\useSettings` | `/_sitemap` | `/createMatch` | `/createPlayer` | `/createTeam` | `/explore` | `/matchSettings` | `/matchSummary` | `/menu` | `/playerRecords` | `/players` | `/settings` | `/teamLineup` | `/toss`;
  type DynamicRoutes<T extends string> = `/player/${SingleRoutePart<T>}`;
  type DynamicRouteTemplate = `/player/[id]`;
