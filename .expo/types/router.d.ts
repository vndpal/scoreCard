...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(tabs)` | `/..\components\MatchPlayerStatsBar` | `/_sitemap` | `/createMatch` | `/createPlayer` | `/createTeam` | `/explore` | `/matchSettings` | `/matchSummary` | `/playerRecords` | `/players` | `/teamLineup` | `/toss`;
